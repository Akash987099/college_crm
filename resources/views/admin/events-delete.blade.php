...
<!-- <button
       ...
       <li class="nav-item">
       <a class="nav-link " href="{{route('events-approved')}}">
          Edit Approvel
       </a>
        </li>
    
        <li class="nav-item">
       <a class="nav-link active" href="{{route('delete-events-approved')}}">
         Delete Approvel
       </a>
        </li>
               </ul>
                  ...
                  <div class="table-responsive text-nowrap">
                    ...
                    <thead class="">
                      ...
                      <th class="fs-6 text-capitalize">S.No.</th>
									...
									<th class="fs-6 text-capitalize"> Director Name</th>
									<th>Action</th>
                      </tr>
                    </thead>
  ...
  <div class="row" id="showsingle">
   ...
   var table = $('#datatable').DataTable({
    ...
    bFilter: false,
    ajax: {
        url: "{{ route('approved-delete-events') }}",
        // type: 'GET',
        // data: function (d) {
        //    ;
        // }
...
$('body').on('click', '.delete', function(e) {
 ...
 $('body').on('click', '.reject', function(e) {
    ...
    // alert(id);
    $.ajax({
        url : "{{route('events-delete-reject')}}",
        type : "GET",
        data : {id : id},
        success : function(response){
            if (response.status == "success") {
