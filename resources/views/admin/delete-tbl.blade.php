...
<!-- <button
       ...
       <li class="nav-item">
       <a class="nav-link " href="{{route('tbl-approved')}}">
          Edit Approvel
       </a>
        </li>
    
        <li class="nav-item">
       <a class="nav-link active" href="{{route('delete-tbl-approved')}}">
         Delete Approvel
       </a>
        </li>
               </ul>
        ...
        },
        {
            data: 'image',
                ...
                render: function (data, type, full, meta) {
                    return type === 'display' ?
                        '<img  style="height:100px;" src="' + "{{ asset('placement') }}/" + data + '" alt="Image" class="img-thumbnail">' :
                        data;
                }
},
        {
