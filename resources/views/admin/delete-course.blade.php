...
<!-- <button
       ...
       <li class="nav-item">
       <a class="nav-link " href="{{route('course-approved')}}">
          Edit Approvel
       </a>
        </li>
    
        <li class="nav-item">
       <a class="nav-link active" href="{{route('delete-course-approved')}}">
         Delete Approvel
       </a>
        </li>
                  ...
                  <div class="table-responsive text-nowrap">
                    ...
                    <thead class="">
                      ...
                      <th class="fs-6 text-capitalize">S.No.</th>
									...
									<th class="fs-6 text-capitalize"> Program Name</th>
									<th>Action</th>
                      </tr>
                    </thead>
  ...
  <div class="row" id="showsingle">
   ...
   var table = $('#datatable').DataTable({
    ...
    bFilter: false,
    ajax: {
        url: "{{ route('approved-delete-course') }}",
        // type: 'GET',
        // data: function (d) {
        //    ;
        // }
...
$('body').on('click', '.delete', function(e) {
 ...
 $('body').on('click', '.reject', function(e) {
    ...
    // alert(id);
    $.ajax({
        url : "{{route('courses-delete-reject')}}",
        type : "GET",
        data : {id : id},
        success : function(response){
            if (response.status == "success") {
