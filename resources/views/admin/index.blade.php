                      ...
                      <div class="col-sm-5 text-center text-sm-left">
                        <div class="card-body pb-0 px-0 px-md-4">
                          <img
                            ...
                            height="140"
                            alt="View Badge User"
                            data-app-dark-img="{{asset('public/illustrations/man-with-laptop-dark.png')}}"
                            data-app-light-img="{{asset('public/illustrations/man-with-laptop-light.png')}}"
                          />
                        </div>
                      </div>
                    </div>
                        ...
                        <div class="card-body">
                          <div class="card-title d-flex align-items-start justify-content-between">
                            <div class="avatar flex-shrink-0">
                              <img
                                src="{{asset('public/assets/img/icons/unicons/chart-success.png')}}"
                                alt="chart success"
                                class="rounded"
                              />
                            </div>
                          ...
                          <div class="card-title d-flex align-items-start justify-content-between">
                            ...
                            <div class="dropdown">
                              ...
                              <div class="dropdown-menu dropdown-menu-end" aria-labelledby="cardOpt6">
                                <a class="dropdown-item" href="{{route('college-view')}}">View More</a>
                              </div>
                            </div>
                          </div>
                          <span>College</span>
                          <h3 class="card-title text-nowrap mb-1">{{$totalCollege}}</h3>
                          ...
                          <div class="card-title d-flex align-items-start justify-content-between">
                            ...
                            <div class="dropdown">
                              ...
                              <div class="dropdown-menu dropdown-menu-end" aria-labelledby="cardOpt4">
                                <a class="dropdown-item" href="{{route('university')}}">View More</a>
                              </div>
                            </div>
                          </div>
                          <span class="d-block mb-1">University</span>
                          <h3 class="card-title text-nowrap mb-2">{{$totalUniversity}}</h3>
