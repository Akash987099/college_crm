...
<!-- <button
       ...
       <li class="nav-item">
       <a class="nav-link " href="{{route('facility-approved')}}">
          Edit Approvel
       </a>
        </li>
    
        <li class="nav-item">
       <a class="nav-link active" href="{{route('delete-facility-approved')}}">
         Delete Approvel
       </a>
        </li>
  ...
  <div class="row" id="showsingle">
   ...
   var table = $('#datatable').DataTable({
    ...
    bFilter: false,
    ajax: {
        url: "{{ route('approved-delete-facility') }}",
        // type: 'GET',
        // data: function (d) {
        //    ;
        // }
...
$('body').on('click', '.delete', function(e) {
    ...
    $.ajax({
        url : "{{route('facility-data-delete')}}",
        type : "GET",
        data : {id : id},
 ...
 $('body').on('click', '.reject', function(e) {
    ...
    // alert(id);
    $.ajax({
        url : "{{route('facility-delete-reject')}}",
        type : "GET",
        data : {id : id},
        success : function(response){
            if (response.status == "success") {
