                    ...
                    <div class="card-body">
                      <div class="d-flex align-items-start align-items-sm-center gap-4">
                        <img
                          ...
                          id="uploadedAvatar"
                        />
                         <form method="POST" id="update-image" enctype="multipart/form-data">
                             @csrf
                    ...
                    <div class="card-body">
                      <form id="formAccountSettings" method="POST" onsubmit="return false">
                        ...
                        <div class="mb-3 col-md-6">
                            <label for="firstName" class="form-label">Assign</label>
                            <input
                              class="form-control"
                              type="text"
                              id="firstName"
                          ...
                          <div class="mb-3 col-md-6">
                            ...
                            <input type="text" class="form-control" id="address" name="address" value="{{Auth::user()->address}}" placeholder="Address" readonly/>
                          </div>
                          <!-- <div class="mb-3 col-md-6">
