                          ...
                          <div class="modal-dialog" role="document">
                            ...
                            <form action="" id="addcountry" method="POST">
                              ...
                              <div class="modal-body">
                                <div class="row">
                                  <div class="col mb-3">
                                    <label for="nameBasic" class="form-label">Program Name<span class="required">*</span></label>
                                    <input type="text" name="program" class="form-control form-range" placeholder="Program Name" />
                                  </div>
                                </div>
                                <!-- <div class="row g-2">
            ...
            <div class="modal-body" >
                ...
                <form method="POST"  class="update_country">
                    ...
                    <input type="text" name="id_input" id="user_id_view" value="" hidden>
                     ...
                     <label for="exampleInputEmail1">Program Name <span class="required">*</span></label>
